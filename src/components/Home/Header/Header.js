    ...
    return (
        <div>
            <nav className="navbar navbar-expand-sm navbar-dark bg-dark">
                <a className="navbar-brand" href="/home">NetCompany</a>
                ...
                <div className="collapse navbar-collapse" id="collapsibleNavId">
                    <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <NavLink activeStyle={{ fontWeight: 'bold' }} className="dropdown-item" to="/todolistrfc">To do list rfc</NavLink>
                            <NavLink  activeStyle={{ fontWeight: 'bold' }} className="dropdown-item" to="/todolist">To do list</NavLink>
                            <NavLink  activeStyle={{ fontWeight: 'bold' }} className="dropdown-item" to="/todolistredux">To do list redux</NavLink> 
                            </div>
                        </li>
